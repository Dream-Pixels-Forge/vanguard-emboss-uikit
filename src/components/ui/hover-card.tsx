...
export function HoverCardTrigger({ className, ...props }: HoverCardTriggerProps) {
  return <HoverCardPrimitive.Trigger className={cn('underline decoration-dotted underline-offset-4', className)} {...props} />
}

export type HoverCardContentProps = React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Content>

export function HoverCardContent({ className, align = 'center', sideOffset = 4, ...props }: HoverCardContentProps) {
  return (
